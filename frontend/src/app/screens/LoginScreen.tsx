...
export default function LoginScreen() {
  ...
  useEffect(() => {
    // Load Google Identity Script lazily if not present
  ...
  const handleCustomGoogleClick = () => {
    if (window.google?.accounts?.id) {
      // Prompt Google One-Tap or native Client ID Auth
      ...
      setError('Google Identity Services SDK loading... Please click again in a moment.');
    }
  };
